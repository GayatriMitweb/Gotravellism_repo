...
<h5 class="booking-section-heading main_block">Passenger Details</h5>
    ...
    ?>    
        <tr class="<?= $bg?>">
            ...
            <td class="hidden"><input type="text" maxlength="20" id="<?php echo 'm_birthdate'.$count_m.'m' ?>" name="<?php echo 'm_birthdate'.$count_m.'m' ?>"  <?= $disabled;?> value="<?php if($row_traveler_grop_details['birth_date']!="") { echo date("d-m-Y", strtotime($row_traveler_grop_details['birth_date'])); } ?>" onchange="calculate_age_member(this.id);" placeholder="Birth Date" title="Birth Date"/></td>
            <td class="hidden"><input type="text" id="<?php echo 'txt_m_age'.$count_m.'m' ?>" name="<?php echo 'txt_m_age'.$count_m.'m' ?>"  <?= $disabled;?> value="<?php echo $row_traveler_grop_details['age'] ?>" placeholder="Age" title="Age(Y:M:D)" onkeyup="adolescence_reflect(this.id)" /></td>
            <td><select id="<?php echo 'txt_m_adolescence'.$count_m.'m' ?>" name="<?php echo 'txt_m_adolescence'.$count_m.'m' ?>">
                    <?php 
