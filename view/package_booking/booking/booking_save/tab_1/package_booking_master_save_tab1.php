    ...
    <div class="row"> <div class="col-xs-12"> <div class="table-responsive">
        <table id="tbl_package_tour_member" class="table table-bordered table-hover table-striped" style="width:1504px">
            <tr>
                ...
                <td class="hidden"><input type="text" maxlength="20" id="m_birthdate1" name="m_birthdate1" onchange="calculate_age_member(this.id); adolescence_reflect(this.id);" value="<?= date('d-m-Y',  strtotime(' -1 day'))?>" placeholder="Birth Date" title="Birth date" /></td>
                <td class="hidden"><input type="text" id="txt_m_age1" name="txt_m_age1" placeholder="*Age" onchange="validate_balance(this.id)" disabled title="Age(Y:M:D)"/></td>
                <td><select id="txt_m_adolescence1" name="txt_m_adolescence1"  title="Adolescence">
