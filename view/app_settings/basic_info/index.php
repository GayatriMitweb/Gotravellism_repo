			    ...
			    callback: function(data1){
			        if(data1=="yes"){
			          $.ajax({
			          	...
			          	data:{ app_version : app_version, currency_code : currency_code, app_contact_no : app_contact_no, app_landline_no : app_landline_no, service_tax_no : service_tax_no,tax_name : tax_name, app_address : app_address, app_website : app_website, app_name : app_name, cin_no : cin_no, pdf_upload_url : pdf_upload_url, state : state,acc_email : acc_email, tax_type : tax_type, tax_pay_date : tax_pay_date, credit_card : credit_card},
