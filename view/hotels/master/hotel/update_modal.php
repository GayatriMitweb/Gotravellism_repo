  ...
  <div class="modal-dialog modal-lg" role="document" style='width:80%'>
    ...
    <div class="panel panel-default panel-body app_panel_style feildset-panel">
        <legend>Basic Information</legend>
            ...
            <div class="col-md-2 col-sm-6 mg_bt_10">
                <input id="total_rooms1" name="total_rooms1" placeholder="Total Rooms" title="Total Rooms" class="form-control" value="<?= $sq_hotel['total_rooms'] ?>"></textarea>
            </div> 
            <div class="col-md-2 col-sm-6 mg_bt_10">
        ...
        <div id="collapse1" class="panel-collapse collapse main_block" role="tabpanel" aria-labelledby="heading1">
          ...
          <div class="row">
              ...
              <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="forex_chk" style='float: left;min-width: 200px;margin-bottom: 10px;'>
                    <?php $chk = (in_array("Intercom", $amenities_arr)) ? "checked" : ""; ?>
                      <input type="checkbox" id="intercom" name="amenities" value="Intercom" <?= $chk ?>>
                      <label for="intercom">Intercom</label>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="forex_chk" style='float: left;min-width: 200px;margin-bottom: 10px;'>
                    <?php $chk = (in_array("Power Backup", $amenities_arr)) ? "checked" : ""; ?>
                      <input type="checkbox" id="pb" name="amenities" value="Power Backup" <?= $chk ?>>
...
$(function(){
    ...
    submitHandler:function(form){
      ...
      var total_rooms = $('#total_rooms1').val();
