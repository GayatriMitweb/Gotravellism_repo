    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row mg_bt_10">
          ...
          <div class="row">
          <div class="col-md-2 col-sm-6 ">
              <input id="total_rooms" name="total_rooms" placeholder="Total Rooms" class="form-control" title="Total Rooms">
            </div>
          </div>
       </div>
            ...
            <div class="panel panel-default panel-body app_panel_style mg_tp_20 feildset-panel">
              ...
              <div class="row mg_tp_10">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="forex_chk" style='float: left;min-width: 200px;margin-bottom: 10px;'>
                        <input type="checkbox" id="pb" name="amenities" value="Power Backup">
            ...
            <div class='row'>
                <div class="col-md-6 col-sm-3 "> 
                  <div class="panel panel-default panel-body app_panel_style mg_tp_30 feildset-panel">
                    ...
                    <div class="col-md-4 col-sm-3 "><label>From Age</label>
                        <select name="cwob_from" id="cwob_from" title="Child Without Bed From Age" class='form-control' data-toggle='tooltip'>
                    ...
                    <div class="col-md-4 col-sm-3 "><label>To Age</label>
                        <select name="cwob_to" id="cwob_to" title="Child Without Bed To Age" class='form-control' data-toggle='tooltip'>
                ...
                <div class="col-md-6 col-sm-3 ">
                  <div class="panel panel-default panel-body app_panel_style mg_tp_30 feildset-panel">
                    ...
                    <div class="col-md-4 col-sm-3 "><label>From Age</label>
                        <select name="cwb_from" id="cwb_from" title="Child With Bed From Age" class='form-control' data-toggle='tooltip'>
                            <option value=''>*From Age</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                            <option value="4">4</option>
                    ...
                    <div class="col-md-4 col-sm-3 "><label>To Age</label>
                        <select name="cwb_to" id="cwb_to" title="Child With Bed To Age" class='form-control' data-toggle='tooltip'>
                            <option value=''>*To Age</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                            <option value="4">4</option>
