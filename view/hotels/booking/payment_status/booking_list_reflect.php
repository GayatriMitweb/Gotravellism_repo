...
$temp_arr = array();
		...
		while($row_booking = mysql_fetch_assoc($sq_booking)){
			...
			$temp_arr = array( "data" => array(
				...
				'<button class="btn btn-info btn-sm" onclick="ticket_view_modal('. $row_booking['booking_id'] .')" data-toggle="tooltip" title="View Detail"><i class="fa fa-eye" aria-hidden="true"></i></button>',
