...
function values_load(id){
	...
	if(condition === '1'){
		...
		html = '<option value="">Select Value</option><option value="NEFT">NEFT</option><option value="RTGS ">RTGS</option><option value="IMPS">IMPS</option><option value="Online">Online</option><option value="Walet">Walet</option>';
		$("#value"+count).html(html);
	}
