...
public function quotation_email()
{
	...
	$tour_date = mysql_fetch_assoc(mysql_query("select * from tour_groups where group_id='$sq_quotation[tour_group]'"));
	...
	<tr>
            <table width="85%" cellspacing="0" cellpadding="5" style="color: #888888;border: 1px solid #888888;margin: 0px auto;margin-top:20px; min-width: 100%;" role="presentation">
			  ...
			  <tr><td style="text-align:left;border: 1px solid #888888;">Tour Date</td>   <td style="text-align:left;border: 1px solid #888888;">'.date('d-m-Y', strtotime($tour_date['from_date'])).' To '.date('d-m-Y', strtotime($tour_date['to_date'])).'</td></tr>
